...
<div class="row align-items-center mb-4">
    <div class="col">
        <h2 class="h5 page-title">แก้ไขกิจกรรม: {{ $event->title_th }}</h2>
    </div>
    <div class="col-auto">
                ...
                <form action="{{ route('admin.events.update', $event->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="title_th" name="title_th" value="{{ old('title_th', $event->title_th) }}" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="title_en">หัวข้อกิจกรรม (อังกฤษ)</label>
                            <input type="text" class="form-control" id="title_en" name="title_en" value="{{ old('title_en', $event->title_en) }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="datetime-local" class="form-control" id="event_start" name="event_start" value="{{ old('event_start', $event->event_start->format('Y-m-d\TH:i')) }}" required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="event_end">วันเวลาสิ้นสุด</label>
                            <input type="datetime-local" class="form-control" id="event_end" name="event_end" value="{{ old('event_end', $event->event_end ? $event->event_end->format('Y-m-d\TH:i') : '') }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea class="form-control" id="description_th" name="description_th" rows="4">{{ old('description_th', $event->description_th) }}</textarea>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="description_en">รายละเอียด (อังกฤษ)</label>
                            <textarea class="form-control" id="description_en" name="description_en" rows="4">{{ old('description_en', $event->description_en) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-control" id="status" name="status">
                            ...
                            <option value="draft" {{ old('status', $event->status) == 'draft' ? 'selected' : '' }}>ฉบับร่าง</option>
                        </select>
                    </div>
