                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <a href="{{ route('admin.board.edit', $director->id) }}" class="btn btn-sm btn-outline-primary shadow-sm" style="border-radius: 8px;">
                                            <i class="bi bi-pencil-square"></i> แก้ไข
                                        </a>
                                        <form action="{{ route('admin.board.destroy', $director->id) }}" method="POST" class="d-inline" onsubmit="return confirm('ต้องการลบข้อมูลกรรมการท่านนี้หรือไม่?');">
                                            @csrf
                                            @method('DELETE')
